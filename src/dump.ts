// This script dumps all the data in redis to json files in the dumps directory.

import { collectJsonEntriesWithKeyPrefix } from "./redis.ts";
import { invitationCode, order, plan, user } from "./schema.ts";
